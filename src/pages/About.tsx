...
const About = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.from("[data-mission]", {
        scrollTrigger: { trigger: "[data-mission-section]", start: "top 80%" },
      ...
      gsap.from("[data-why]", {
        scrollTrigger: { trigger: "[data-why]", start: "top 80%" },
  ...
  return (
    <div className="min-h-screen bg-background pb-20 md:pb-0">
      ...
      {/* Mission */}
      <section className="py-20 bg-card" data-mission-section>
      ...
      <section className="py-20 bg-card">
        <div className="container px-4 md:px-8 max-w-3xl mx-auto text-center" data-why>
